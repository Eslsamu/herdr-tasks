...
The test suite covers queue ownership, concurrent claims, dependencies, resume/fork identity, default/custom/conflicting shortcut configuration, terminal rendering, browser DTO privacy, immutable space routing, HTTP method/host/token rejection, live revisions, viewer restart/reuse, and installed CLI execution. CI runs on macOS and Linux with Python 3.10 and 3.14.
